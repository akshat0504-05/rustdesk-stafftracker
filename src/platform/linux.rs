...
lazy_static::lazy_static! {
    ...
    // https://github.com/rustdesk/STRemote/issues/13705
...
pub fn start_os_service() {
    ...
    while running.load(Ordering::SeqCst) {
        ...
        if keeps_headless || keeps_session {
            // for fixing https://github.com/rustdesk/STRemote/issues/3129 to avoid too much dbus calling,
            sleep_millis(500);
        } else {
            sleep_millis(super::SERVICE_INTERVAL);
        }
...
///
/// https://github.com/rustdesk/STRemote/discussions/11959
///
...
pub fn check_autostart_config() -> ResultType<()> {
    ...
    // https://github.com/rustdesk/STRemote/issues/4863
