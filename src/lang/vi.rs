...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới STRemote..."),
        ...
        ("install_tip", "Do cơ chế UAC, STRemote có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt STRemote vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho STRemote."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho STRemote."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [STRemote Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep STRemote background service", "Giữ dịch vụ STRemote chạy nền"),
        ...
        ("verify_STRemote_password_tip", "Xác thực mật khẩu STRemote"),
        ...
        ("scam_text2", "Chỉ sử dụng STRemote với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_STRemote_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ STRemote mở"),
        ...
        ("floating_window_tip", "Giữ STRemote trên cùng"),
        ...
        ("upgrade_remote_STRemote_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
