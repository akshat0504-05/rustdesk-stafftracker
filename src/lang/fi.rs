...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään STRemote verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa STRemote ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi STRemotein järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava STRemoteille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava STRemoteille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten STRemote daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota STRemoteille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli STRemote ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "STRemote palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa STRemotein asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "STRemote palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep STRemote background service", "Pidä STRemotein taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista STRemotein akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_STRemote_password_tip", "Vahvista STRemote salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "STRemote ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_STRemote_server_pro_to_{}_tip", "Päivitä STRemote Server Pro versioon {} jatkaaksesi."),
        ...
        ("About STRemote", "Tietoa STRemoteistä"),
        ...
        ("upgrade_remote_STRemote_client_to_{}_tip", "Päivitä etä-STRemote-asiakasversioon {} yhteensopivuuden takaamiseksi"),
