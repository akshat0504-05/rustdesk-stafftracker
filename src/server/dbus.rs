...
///
/// Note:
/// On linux, we use dbus to communicate multiple STRemote process.
...
const DBUS_NAME: &str = "org.STRemote.STRemote";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "STRemote DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.STRemote.STRemote /dbus org.STRemote.STRemote.NewConnection string:'PEER_ID'`
