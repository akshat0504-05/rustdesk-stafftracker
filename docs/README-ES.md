...
[**¿Cómo funciona STRemote?**](https://github.com/rustdesk/STRemote/wiki/How-does-STRemote-work%3F)

[**DESCARGA DE BINARIOS**](https://github.com/rustdesk/STRemote/releases)
...
- **[libs/hbb_common](https://github.com/rustdesk/STRemote/tree/master/libs/hbb_common)**:  codec de video, configuración, tcp/udp wrapper, protobuf, funciones para transferencia de archivos, y otras funciones de utilidad.
- **[libs/scrap](https://github.com/rustdesk/STRemote/tree/master/libs/scrap)**: captura de pantalla
- **[libs/enigo](https://github.com/rustdesk/STRemote/tree/master/libs/enigo)**: control del teclado/mouse especificos de cada plataforma
- **[src/ui](https://github.com/rustdesk/STRemote/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/rustdesk/STRemote/tree/master/src/server)**: sonido/portapapeles/input/servicios de video, y conexiones de red
- **[src/client.rs](https://github.com/rustdesk/STRemote/tree/master/src/client.rs)**: iniciar una conexión "peer to peer"
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/STRemote/tree/master/src/rendezvous_mediator.rs)**: Comunicación con [STRemote-server](https://github.com/rustdesk/STRemote-server), esperar la conexión remota directa ("TCP hole punching") o conexión indirecta ("relayed")
- **[src/platform](https://github.com/rustdesk/STRemote/tree/master/src/platform)**: código específico de cada plataforma
- **[flutter](https://github.com/rustdesk/STRemote/tree/master/flutter)**: Flutter, código para moviles
- **[flutter/web/js](https://github.com/rustdesk/STRemote/tree/master/flutter/web/js)**: Javascript para el cliente web Flutter
