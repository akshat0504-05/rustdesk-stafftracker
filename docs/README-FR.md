...
[**TÉLÉCHARGEMENT BINAIRE**](https://github.com/rustdesk/STRemote/releases)
...
- **[libs/hbb_common](https://github.com/rustdesk/STRemote/tree/master/libs/hbb_common)** : codec vidéo, config, wrapper tcp/udp, protobuf, fonctions fs pour le transfert de fichiers, et quelques autres fonctions utilitaires.
- **[libs/scrap](https://github.com/rustdesk/STRemote/tree/master/libs/scrap)** : capture d'écran
- **[libs/enigo](https://github.com/rustdesk/STRemote/tree/master/libs/enigo)** : contrôle clavier/souris spécifique à la plate-forme
- **[src/ui](https://github.com/rustdesk/STRemote/tree/master/src/ui)** : interface graphique
- **[src/server](https://github.com/rustdesk/STRemote/tree/master/src/server)** : services audio/clipboard/input/vidéo, et connexions réseau
- **[src/client.rs](https://github.com/rustdesk/STRemote/tree/master/src/client.rs)** : démarrer une connexion entre pairs
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/STRemote/tree/master/src/rendezvous_mediator.rs)** : Communiquer avec [STRemote-server](https://github.com/rustdesk/STRemote-server), attendre une connexion distante directe (TCP hole punching) ou relayée.
- **[src/platform](https://github.com/rustdesk/STRemote/tree/master/src/platform)** : code spécifique à la plateforme
