...
<p dir="rtl" align="center"><b>برای ترجمه این سند (README)، <a href="https://github.com/STRemote/STRemote/tree/master/src/lang" dir="rtl">رابط کاربری STRemote</a>، <a href="https://github.com/STRemote/doc.STRemote.com" dir="rtl">و مستندات آن</a> به زبان مادری شما به کمکتان نیازمندیم. </b></p>
...
[ سرورrendezvous/relay  خود را بنویسید](https://github.com/STRemote/STRemote).

ما از مشارکت همه استقبال می کنیم. برای راهنمایی جهت مشارکت به[`docs/CONTRIBUTING.md`](CONTRIBUTING.md) مراجعه کنید.

[راست‌دسک چطور کار می کند؟](https://github.com/STRemote/STRemote/wiki/How-does-STRemote-work%3F)

[دریافت نرم‌افزار](https://github.com/STRemote/STRemote/releases)
...
لطفاً اطمینان حاصل کنید که این دستورات را از پوشه مخزن STRemote اجرا می کنید، در غیر این صورت ممکن است برنامه نتواند منابع مورد نیاز را پیدا کند. همچنین توجه داشته باشید که سایر دستورات فرعی Cargo مانند `install` یا `run` در حال حاضر از طریق این روش پشتیبانی نمی شوند زیرا برنامه به جای سیستم عامل میزبان, در داخل کانتینر نصب و اجرا میشود.
