<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/STRemote/STRemote/tree/master/src/lang">a STRemote UI-t</a> és a <a href="https://github.com/STRemote/doc.STRemote.com">Dokumentációt</a> az anyanyelvedre</b>
</p>
...
A STRemote egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a STRemote punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://STRemote.com/server), vagy akár [írhatsz is egyet](https://github.com/STRemote/STRemote-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A STRemote szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a STRemote?**](https://github.com/STRemote/STRemote/wiki/How-does-STRemote-work%3F)

[**BINARY LELTÖLTÉS**](https://github.com/STRemote/STRemote/releases)
...
Ezután, minden egyes alkalommal amikor meg kell építened a STRemote-et, futtasd a kövezkező parancsot:
...
Kérlek mindenképpen nézd meg hogy ezeket a parancsokat a root STRemote mappában futtatod e, különben a STRemote lehet hogy nem fogja megtalálni az építéshez szükséges elemeket. Fontos az is, hogy jelenleg más cargo subparancsok, például `install`vagy `run` nem támogatottak, mivel egy Dockeres építés esetén elindítanák a programot a containeren belül.
