...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (STRemoteWinManager.getActiveWindows().contains(kMainWindowId)) {
        await STRemoteWinManager.unregisterActiveWindow(kMainWindowId);
      }
