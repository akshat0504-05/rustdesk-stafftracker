...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/STRemote/STRemote/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsSTRemoteVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsSTRemoteVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsSTRemoteVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/STRemote/STRemote/pull/3706#issuecomment-1481242389
  ...
  void edgeScrollMouse(double x, double y) async {
    ...
    if (encroachment.length2 == 0) {
      ...
      var bumpMouseSucceeded = _bumpMouseIsWorking &&
          (await STRemoteWinManager.call(WindowType.Main, kWindowBumpMouse,
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get STRemoteVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsSTRemoteVirtualDisplays] ?? []);
  ...
  bool get isSTRemoteIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'STRemote_idd';
