...
class STRemoteMultiWindowManager {
  STRemoteMultiWindowManager._();

  static final instance = STRemoteMultiWindowManager._();
  ...
  /// `STRemoteWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final STRemoteWinManager = STRemoteMultiWindowManager.instance;
